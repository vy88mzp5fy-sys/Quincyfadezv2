...
export default function AdminPaymentsPanel({ settings, capabilities, saving, onSave }) {
    ...
    <View style={styles.wrap}>
      <View style={styles.hero}>
        ...
        <View style={styles.systemStatus}>
          <View><Text style={styles.systemLabel}>MONEY-MOVING STATUS</Text><Text style={styles.systemValue}>{anyLive ? "LIVE CAPABILITIES DETECTED" : "SAFE CONFIGURATION MODE"}</Text></View>
          <View style={[styles.systemPill, anyLive && styles.systemPillLive]}><Text style={[styles.systemPillText, anyLive && styles.systemPillTextLive]}>{anyLive ? "LIVE" : "PROTECTED"}</Text></View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  wrap:{gap:14},hero:{borderRadius:20,borderWidth:1,borderColor:"#3A3020",backgroundColor:"#0E0B07",padding:17},heroTop:{flexDirection:"row",alignItems:"center",gap:12},heroMark:{width:44,height:44,borderRadius:22,borderWidth:1,borderColor:"#604A24",backgroundColor:"#171106",alignItems:"center",justifyContent:"center"},heroMarkText:{color:GOLD_LIGHT,fontSize:20,fontWeight:"900"},heroCopy:{flex:1},eyebrow:{color:GOLD,fontSize:7,letterSpacing:1.5,fontWeight:"900"},title:{color:"#F4F4F4",fontSize:18,fontWeight:"750",marginTop:5},heroText:{color:MUTED,fontSize:9.5,lineHeight:15.5,marginTop:13},systemStatus:{minHeight:62,borderRadius:14,borderWidth:1,borderColor:"#2C281F",backgroundColor:"#090807",marginTop:14,paddingHorizontal:12,flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:10},systemLabel:{color:"#75664D",fontSize:6,letterSpacing:.9,fontWeight:"900"},systemValue:{color:"#D9D2C5",fontSize:9,fontWeight:"800",marginTop:4},systemPill:{borderRadius:11,borderWidth:1,borderColor:"#5A4523",backgroundColor:"#151005",paddingHorizontal:8,paddingVertical:6},systemPillLive:{borderColor:"#315342",backgroundColor:"#09110D"},systemPillText:{color:GOLD_LIGHT,fontSize:5.8,letterSpacing:.7,fontWeight:"900"},systemPillTextLive:{color:"#91D1AD"},
