...
function DiaryBooking({ booking, busy, onAction }) {
  ...
  return <View style={[styles.bookingCard, status === "completed" && styles.bookingCardComplete, status === "no_show" && styles.bookingCardNoShow]}>
    <View style={styles.bookingMain}>
      ...
      <View style={styles.bookingCopy}><Text style={styles.name}>{booking.customer_name || "Client"}</Text><Text style={styles.service}>{booking.service}</Text><Text style={styles.meta}>{money(booking.price)} · {formatDate(booking.start_at)}</Text></View>
