...
export default function ClientManagementPanel({ client, busy, onUpdate }) {
  ...
  return <View style={styles.card}>
    ...
    <View style={styles.sectionHeadingRow}><Text style={styles.sectionLabelInline}>CLIENT TAGS</Text>{tags.length ? <Pressable disabled={busy} onPress={clearTags}><Text style={styles.clearText}>CLEAR</Text></Pressable> : null}</View>
