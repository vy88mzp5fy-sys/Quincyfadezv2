...
export default function PersonalInformationScreen({onBack}){
  ...
  return <Marble><SafeAreaView style={s.safe}><StatusBar barStyle="light-content"/><ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
    ...
    <Surface style={s.note}><View style={s.noteIcon}><Text style={s.noteGlyph}>ℹ️</Text></View><View style={{flex:1}}><Text style={s.noteTitle}>Keep this accurate</Text><Text style={s.noteText}>These details are used to pre-fill bookings and help QuincyFadez contact you about an appointment.</Text></View></Surface>
...
const s=StyleSheet.create({safe:{flex:1},content:{paddingHorizontal:18,paddingTop:4,paddingBottom:84},saved:{height:46,borderRadius:14,borderWidth:1,borderColor:"rgba(120,214,164,.22)",backgroundColor:"rgba(120,214,164,.08)",alignItems:"center",justifyContent:"center",marginTop:7,marginBottom:11},savedText:{color:M.green,fontSize:11,fontWeight:"900"},card:{padding:17,marginTop:9,backgroundColor:M.panel2},field:{marginBottom:17},label:{color:M.text2,fontSize:12,fontWeight:"700",marginBottom:8},input:{height:58,borderRadius:16,borderWidth:1,borderColor:"rgba(255,255,255,.11)",backgroundColor:M.bg2,paddingHorizontal:15,color:M.text,fontSize:15},help:{color:M.muted2,fontSize:10,lineHeight:14,marginTop:7},note:{padding:17,marginTop:15,flexDirection:"row",gap:12,backgroundColor:M.panel2,borderColor:"rgba(255,255,255,.11)"},noteIcon:{width:44,height:44,borderRadius:14,backgroundColor:M.panel3,borderWidth:1,borderColor:"rgba(255,255,255,.11)",alignItems:"center",justifyContent:"center"},noteGlyph:{fontSize:17},noteTitle:{color:M.text,fontSize:14,fontWeight:"800"},noteText:{color:M.muted,fontSize:11,lineHeight:16,marginTop:5},primary:{marginTop:17}});
