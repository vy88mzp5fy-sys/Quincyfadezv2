...
const s=StyleSheet.create({
  shell:{flex:1,backgroundColor:M.bg},body:{flex:1},boot:{flex:1,alignItems:"center",justifyContent:"center"},bootBrand:{color:M.text,fontSize:13,fontWeight:"900",letterSpacing:3.2,marginTop:14},navSafe:{position:"absolute",left:12,right:12,bottom:8},nav:{height:76,borderRadius:22,borderWidth:1,borderColor:"rgba(255,255,255,.08)",backgroundColor:"rgba(15,15,15,.98)",flexDirection:"row",alignItems:"center",paddingHorizontal:6,shadowColor:"#000",shadowOpacity:.35,shadowRadius:18,shadowOffset:{width:0,height:10},elevation:7},navItem:{flex:1,height:66,alignItems:"center",justifyContent:"center"},navIconWrap:{width:36,height:32,borderRadius:12,alignItems:"center",justifyContent:"center"},navIconOn:{backgroundColor:"rgba(214,183,92,.10)"},bookWrap:{width:46,height:46,borderRadius:16,backgroundColor:M.accent,marginTop:-16,shadowColor:"#000",shadowOpacity:.24,shadowRadius:12,shadowOffset:{width:0,height:6},elevation:5},bookWrapOn:{backgroundColor:M.accentSoft},navIcon:{color:M.muted,fontSize:17,fontWeight:"700"},navIconActive:{color:M.accentSoft},bookIcon:{color:M.bg,fontSize:22,fontWeight:"700"},navLabel:{color:M.muted2,fontSize:7.5,fontWeight:"700",marginTop:4},navLabelOn:{color:M.text2}
});
