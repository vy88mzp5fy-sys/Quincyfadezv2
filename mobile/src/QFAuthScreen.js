...
const s=StyleSheet.create({
  safe:{flex:1},content:{flexGrow:1,paddingHorizontal:22,paddingTop:34,paddingBottom:34,justifyContent:"center"},brand:{alignItems:"center",marginBottom:24},wordmark:{color:M.text,fontSize:15,fontWeight:"800",letterSpacing:3.6,marginTop:14},tag:{color:M.muted,fontSize:8,fontWeight:"700",letterSpacing:1.6,marginTop:7},card:{padding:19},cardHead:{marginBottom:5},title:{color:M.text,fontSize:28,fontWeight:"700",letterSpacing:-.7},copy:{color:M.muted,fontSize:11.5,lineHeight:17,marginTop:7,maxWidth:330},field:{marginTop:15},fieldTop:{height:20,flexDirection:"row",alignItems:"center",justifyContent:"space-between"},label:{color:M.text2,fontSize:10.5,fontWeight:"700"},fieldAction:{color:M.accentSoft,fontSize:10,fontWeight:"700"},input:{height:55,borderRadius:15,borderWidth:1,borderColor:"rgba(255,255,255,.08)",backgroundColor:"rgba(8,11,16,.68)",color:M.text,fontSize:14,paddingHorizontal:14,marginTop:5},helper:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginTop:15},toggleRow:{flexDirection:"row",alignItems:"center",gap:8,flexShrink:1},checkBox:{width:20,height:20,borderRadius:7,borderWidth:1,borderColor:"rgba(255,255,255,.13)",backgroundColor:"rgba(8,11,16,.65)",alignItems:"center",justifyContent:"center"},checkBoxOn:{borderColor:"rgba(169,184,255,.55)",backgroundColor:"rgba(169,184,255,.15)"},check:{color:M.accentSoft,fontSize:11,fontWeight:"900"},toggleLabel:{color:M.muted,fontSize:9.8,flexShrink:1},link:{color:M.accentSoft,fontSize:10.5,fontWeight:"700"},terms:{marginTop:15},error:{borderRadius:13,borderWidth:1,borderColor:"rgba(255,142,150,.22)",backgroundColor:M.redBg,padding:11,marginTop:14},errorText:{color:M.red,fontSize:10.5,lineHeight:15},submit:{marginTop:17},divider:{flexDirection:"row",alignItems:"center",gap:10,marginVertical:15},line:{height:1,flex:1,backgroundColor:"rgba(255,255,255,.055)"},or:{color:M.muted2,fontSize:8,fontWeight:"800",letterSpacing:1},secondary:{height:50,borderRadius:15,borderWidth:1,borderColor:"rgba(255,255,255,.08)",backgroundColor:"rgba(21,28,40,.66)",alignItems:"center",justifyContent:"center"},secondaryText:{color:M.text2,fontSize:11,fontWeight:"700"},backLink:{alignItems:"center",marginTop:17},ownerLink:{alignSelf:"center",flexDirection:"row",alignItems:"center",gap:7,marginTop:18,padding:8},ownerDot:{width:6,height:6,borderRadius:3,backgroundColor:M.muted2},ownerText:{color:M.muted,fontSize:9.5,fontWeight:"700"}
});
