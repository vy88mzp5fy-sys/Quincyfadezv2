...
const s=StyleSheet.create({
  safe:{flex:1},content:{paddingHorizontal:18,paddingTop:4,paddingBottom:80},saved:{height:42,borderRadius:13,borderWidth:1,borderColor:"rgba(120,214,164,.22)",backgroundColor:"rgba(120,214,164,.08)",alignItems:"center",justifyContent:"center",marginTop:6},savedText:{color:M.green,fontSize:9.5,fontWeight:"900"},section:{color:M.text2,fontSize:8.8,fontWeight:"900",letterSpacing:1.05,marginTop:22,marginBottom:9},card:{overflow:"hidden",backgroundColor:M.panel},choice:{minHeight:74,paddingHorizontal:14,flexDirection:"row",alignItems:"center",gap:12},choiceOn:{backgroundColor:"rgba(244,197,66,.09)"},radio:{width:23,height:23,borderRadius:12,borderWidth:1,borderColor:"rgba(255,255,255,.16)",alignItems:"center",justifyContent:"center"},radioOn:{borderColor:M.accent,backgroundColor:"rgba(244,197,66,.08)"},dot:{width:11,height:11,borderRadius:6,backgroundColor:M.accent},choiceTitle:{color:M.text2,fontSize:12.7,fontWeight:"700"},choiceTitleOn:{color:M.text,fontWeight:"800"},choiceSub:{color:M.muted,fontSize:9.2,marginTop:4},line:{height:1,backgroundColor:"rgba(255,255,255,.07)",marginLeft:49},note:{padding:15,marginTop:20,flexDirection:"row",gap:12,alignItems:"flex-start",backgroundColor:M.panel2,borderColor:"rgba(244,197,66,.18)"},spark:{width:42,height:42,borderRadius:13,backgroundColor:M.panel3,borderWidth:1,borderColor:"rgba(244,197,66,.24)",alignItems:"center",justifyContent:"center"},sparkText:{fontSize:18},noteTitle:{color:M.text,fontSize:12.7,fontWeight:"800"},noteText:{color:M.muted,fontSize:9.5,lineHeight:14.5,marginTop:4},primary:{marginTop:16}
});
